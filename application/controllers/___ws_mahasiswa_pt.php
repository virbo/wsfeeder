...
class Ws_mahasiswa_pt extends CI_Controller {
    ...
    public function view($offset=0)
    {
        ...
        //pagination
        $config['base_url'] = site_url('ws_mahasiswa_pt/view');
        ...
        $data['url_add'] = 'index.php/ws_mahasiswa_pt/form';
    ...
    {
        $row = 1;
        if (($handle = fopen(base_url()."FILE/test_csv.csv", "r")) !== FALSE) {
...
/* End of file ws_mahasiswa_pt.php */
/* Location: ./application/controllers/ws_mahasiswa_pt.php */
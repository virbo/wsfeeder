        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php
                    ...
                    echo form_open('ref_status/view',$attributes);
                ?>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nm_status" placeholder="Search..." value="<?php echo $temp_status;?>">

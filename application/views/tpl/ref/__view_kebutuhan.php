        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php
                    ...
                    echo form_open('ref_kebutuhan/view',$attributes);
                ?>
                    <div class="input-group">
                        <input type="text" class="form-control" name="nm_keb" placeholder="Search..." value="<?php echo $temp_keb;?>">

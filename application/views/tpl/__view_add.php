...
<div class="row">
    <div class="col-md-6">
        ...
        <a href="javascript:void();" class="modalButton btn btn-warning" data-toggle="modal" data-src="<?php echo base_url();?>index.php/welcome/listdir/mahasiswa_pt" data-target="#modalku">
